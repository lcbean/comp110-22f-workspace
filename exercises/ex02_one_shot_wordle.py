...
while len(user_guess) != len(secret_word):
        ...
        user_guess: str = input(f"That was not {letters} letters! Try again: ")
...
while current_letter < len(secret_word):
        if secret_word[current_letter] == user_guess[current_letter]:
                ...
                other_index: int = 0
                while different_spot != True and other_index < len(secret_word):
                        if secret_word[other_index] == user_guess[current_letter]:
                                different_spot = True 
                        else: 
                                other_index = other_index + 1
                        if different_spot == True:
                                result = result + YELLOW_BOX
                if different_spot == False:
